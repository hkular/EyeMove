function [stim] = gazeControl_HK(doET,p,trial,stim,win)
...
% win: window pointer
% 1/31/24 edited from gazeControl_SP.m
% confirm that gaze reached and stayed on a point

%INPUTS
% doET: 0 if not eyetracking
% p: parameters need violationMaxDur, EyeLinkDefaults saccDet, eyeDirectFB,
% xcenter ycenter, black, fixationDot, fixTol
% trial: trial number
% stim: stimulus parameters need gazeViolationType gazeViolationIdx eyeUsed
% violationOnset
% win: screen number
